...
const Page = () =>{
    ...
    const {mutate: sendMessage, isPending} = useMutation({
        mutationFn: async({text}: {text:string})=>{
             console.log("Sending:", { sender: username, text, roomId })
...
return <main className="flex flex-col h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-xs text-zinc-300 uppercase">Room ID</span>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={copyLink} className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 rounded text-zinc-200 transition-colors">
                        {copyStatus}
                    </button>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin">
            ...
            {messages?.messages.length===0 && (<div className="flex items-center justify-center h-full">
                <p className="text-zinc-600 text-sm font-mono">No messages yet, start your convo</p>
            </div>
        ...
        {messages?.messages.map((msg)=>(
            <div key={msg.id} className="flex flex-col items-start">
                <div className="max-w-[80%] gap-3 mb-1">
        ...
        <div className="flex-1 relative group">
            ...
            className="w-full bg-color border border-zinc-800 focus:border-zinc-700 focus: outline-none transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8 pl-4 text-sm"
            />
